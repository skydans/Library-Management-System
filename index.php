		...
		<div class="row-fluid">
			<div class="span12">
				...
				<ul class="nav nav-tabs">
					<li <?php echo $app=='home_index'?'class="active"':'';?>><a href="index.php"><i class="icon-home"></i> Home</a></li>
					<li <?php echo $app=='about'?'class="active"' :'';?>><a href="index.php?app=about"><i class="icon-info-sign"></i> About</a></li>
