...
isset ($_GET['app']) ? $app = $_GET['app'] : $app = 'admin_home';
		...
		<div class="row-fluid">
			<div class="span12">
				...
				<ul class="nav nav-tabs">
					<li <?php echo $app=='admin_home'?'class="active"':'';?>><a href="homeadmin.php"><i class="icon-home"></i> Home</a></li>
					
					<?php if(isset($_SESSION['level'])){?>
					<li <?php echo $app=='admin_tranz_menu'?'class="active"':'';?>><a href="homeadmin.php?app=admin_tranz_menu"><i class="icon-th-large"></i> Transactions</a></li>
					<li <?php echo $app=='admin_fine_list'?'class="active"' :'';?>><a href="homeadmin.php?app=admin_fine_list"><i class="icon-th-list"></i> Fines</a></li>
					<li <?php echo $app=='admin_book_list'?'class="active"':'';?>><a href="homeadmin.php?app=admin_book_list"><i class="icon-book"></i> Book List</a></li>
					<li <?php echo $app=='admin_admin_list'?'class="active"':'';?>><a href="homeadmin.php?app=admin_admin_list"><i class="icon-wrench"></i> Admin Data</a></li>
					<li <?php echo $app=='admin_user_list'?'class="active"' :'';?>><a href="homeadmin.php?app=admin_user_list"><i class="icon-tags"></i> User Data</a></li>
					<li <?php echo $app=='about'?'class="active"' :'';?>><a href="homeadmin.php?app=about"><i class="icon-info-sign"></i> About</a></li>
					<?php }?>
